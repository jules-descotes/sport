...
/**
 * **Training** — objectifs mesurés, formules, séances.
 *
 * Reprend la moitié « corps » de l'ancien écran Corps, qui a éclaté le 13/09
 * en Training et Nutrition. Coquille jusqu'au lot 4 : les trois jauges sont
 * vides et le disent.
 *
 ...
 * chacune. Une jauge à moitié pleine se lirait comme une mesure.
 */
    ...
    <main className="pb-6">
      ...
      <section className="px-5 pt-6">
        <p className="rounded-card border border-dashed border-line bg-soft px-5 py-5 text-[14px] leading-snug text-ink-2">
          ...
          mesure toutes les deux ou trois semaines. Les formules
          d&apos;entraînement et le mode séance arrivent au lot 4.
        </p>
      </section>
    </main>
  );
